...
<nav class="navbar navbar-inverse" role="navigation">
  ...
  <a class="navbar-brand" href="index.php"><img src="icon.png" height="25" width="25"> NASA Photo quiz</a>
	...
	<div class="jumbotron">
  		<h3><strong>Houston, we have a problem. I've made a mistake!</strong></h3>
  		<p><img src="http://grin.hq.nasa.gov/IMAGES/SMALL/GPN-2000-001159.jpg" height="310" width="470"></p>
